...
def get_args():
    parser = argparse.ArgumentParser('carotid copilot - pose train', add_help=False)
    ...
    parser.add_argument('--data_rootdir', default='/home/mingcong/project/us_carotid/pose_pilot/yolotrain/translation_fake/')                    
    ...
    parser.add_argument('--project', type=str, default='CarotidPoseTrain', help='WandB project name')
...
def main():
    ...
    for epoch in range(args.epochs):
        ...
        print(f"E{epoch:03d} | "
              f"Train {train_total:.4f}, {train_abs_total:.4f} | Val {val_total:.4f}, {bound_open_val:.4f} | LR {current_lr:.2e} | "
              f"real Train={train_loss_real:.4f} mm | "
              f"real Val={val_loss_real:.4f} mm")
        ...
        if args.wandb:
            wandb.log({
                ...
                'train/loss_abs': train_abs_total,
                'train/real_error_mm': train_loss_real,
                'val/loss': val_total,
                'val/bound_open': bound_open_val,
                'val/real_error_mm': val_loss_real,
                'lr': current_lr,
                'epoch': epoch
            })
        # ====================================================
