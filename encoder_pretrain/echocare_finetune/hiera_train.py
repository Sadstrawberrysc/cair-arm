...
from models.hiera_head import HieraHead
...
def main():
    ...
    logger = create_logger(output_dir=logdir, dist_rank=dist.get_rank(), name='hiera-mae')

    logger.info(f"Creating model...")
    model = HieraHead(args, n_hiera_class=42)
    model.cuda()
