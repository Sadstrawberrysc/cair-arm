...
class GuiDisplayModel(QObject):
    ...
    chatMessagesChanged = pyqtSignal()
    ...
    # 聊天记录属性
    @pyqtProperty(list, notify=chatMessagesChanged)
    def chatMessages(self):
        return self._chat_messages

    @chatMessages.setter
    def chatMessages(self, value):
        if self._chat_messages != value:
            self._chat_messages = value
    ...
    def set_chat_messages(self, messages: list):
        """
        更新聊天消息.
        """
