...
from src.redis_client import UltrasoundRedisMockClient
# from src.robolight_control import LightController as RealLightController  # 可能不存在
# from src.roboredis_arm import ArmCommandPublisher  # 可能不存在或连接失败
# from src.robochat import load_bodypart_presets
...
class Application:
    ...
    def __init__(self):
        ...
        # redis
        self.redis_publisher = UltrasoundRedisMockClient(redis_host='localhost', redis_port=6379)
        ...
        self.presets = None
        self.last_status = self.redis_publisher.send_raw_command("get_status()").get('data')
    ...
    async def connect_protocol(self):
        ...
        try:
            ...
            if not self._connect_lock:
                ...
                await self.protocol.send_last_status_update(self.last_status)
                return True
