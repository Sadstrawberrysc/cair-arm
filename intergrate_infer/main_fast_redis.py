...
# Keep the live ultrasound input identical to infer/pose_pred/main_fast.py.
# NumPy shape is (height, width): rows 160:800 and columns 510:1110 produce
# a 640x600 BGR frame. Do not flip before cropping because the trained pose
# and phase models expect this exact orientation.
...
def main():
    ...
    while inference_running:
        ...
        cavana = frame.copy()
        cavana = cv2.resize(cavana, (1400, 1200))
